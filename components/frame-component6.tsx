...
const FrameComponent6: NextPage<FrameComponent6Type> = ({
  ...
  return (
    <div
      className={`rounded-29xl [background:radial-gradient(50%_50%_at_50%_50%,_rgba(255,_255,_255,_0.08),_rgba(255,_255,_255,_0)),_linear-gradient(130.02deg,_rgba(95,_46,_216,_0.01),_rgba(95,_46,_216,_0.01))] flex flex-col items-start justify-center gap-[32px] text-left text-xl text-new-1f font-work-sans mq450:gap-[16px] ${className}`}
    >
      <img

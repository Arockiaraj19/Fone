...
export type DeviceTypesType = {
  className?: string;
};

const DeviceTypes: NextPage<DeviceTypesType> = ({ className = "" }) => {
  return (
    <section
    ...
    >
      ...
      <div className="w-16 flex flex-col items-center justify-start py-0 px-0 box-border gap-[8px]">
        <img
          className="w-16 h-16 relative"
          loading="lazy"
          alt=""
